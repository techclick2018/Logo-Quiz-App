...
class QuizQuestionsActivity : AppCompatActivity(),View.OnClickListener {
    ...
    private var mQuestionsList: ArrayList<Question>? = null   //ArrayList of Question of null type
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setQuestion()  //function setting question
    ...
    override fun onClick(v: View?) {
        ...
        //used to get id of selected option
        when (v?.id) {
